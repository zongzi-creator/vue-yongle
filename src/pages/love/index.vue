<template>
  <div id="body" class="love-body">
    ...
    <div class="btns disabled-loveBtn">
      <a href="/" class="min-btn red gradual-lightRed nuxt-link-active">去逛逛</a>
    </div>
  </div>
</template>
<script>
...
.gradual-lightRed {
  background: linear-gradient(
    135deg,
    rgba(255, 126, 111, 0.2) 0%,
    rgba(255, 41, 89, 0.2) 100%
  );
